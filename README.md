...
<div align="center">
  <h2>Zomato Clone using React JS</h2>
...
Find the link for the complete documentation of the Zomato Clone using React JS [here](https://enatega.com/multivendor-documentation/).
...
[Check out the Product Page and Pricing and more for Zomato Clone using React JS](https://enatega.com/?utm_source=github&utm_medium=repo&utm_campaign=mary-zomato-clone-using-react-js)
